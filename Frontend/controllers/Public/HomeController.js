$(document).ready(function () {
    ...
    var third = '<p class="h2" id="tittleName">কেএফটি-হাজী আব্দুল কাদের মোল্লা-ফাতেমা বেগম ট্রাস্ট</p> <i id="mottoText">"একটি উন্নত সমাজের স্বপ্ন"</i>';
    var fourth = '<p class="h2" id="tittleName">কেএফটি কলেজিয়েট স্কুল</p> <i id="mottoText">"বিশ্বাস | আত্মবিশ্বাস | অখণ্ডতা | সৃজনশীলতা"</i>';
